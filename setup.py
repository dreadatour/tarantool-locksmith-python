...
setup(
    name='tarantool-locksmith',
    version=find_version('src', 'tarantool_locksmith', '__init__.py'),
    license='MIT',
    description='Python bindings for Tarantool locksmith script',
    long_description=read('README.md'),
    author='Vladimir Rudnyh',
    author_email='rudnyh@corp.mail.ru',
    url='https://github.com/dreadatour/tarantool-locksmith-python',
